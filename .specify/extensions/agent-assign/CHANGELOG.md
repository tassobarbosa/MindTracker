...
- `speckit.agent-assign.assign` — Scan GitHub Copilot agent definitions and assign them to tasks
...
- Agent discovery following GitHub Copilot's priority hierarchy (project > user)
