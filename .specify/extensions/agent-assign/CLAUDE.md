...
A [Spec-Kit](https://github.com/github/spec-kit/) extension that adds agent assignment capabilities to the task execution workflow. It allows tasks in `tasks.md` to be assigned to specialized GitHub Copilot agents, validated, and executed via dedicated subagents.
...
Agent definitions are discovered following GitHub Copilot's official priority (high overrides low):
1. **Project-level**: `.github/agents/*.md`
2. **User-level**: `~/.github/agents/*.md`
