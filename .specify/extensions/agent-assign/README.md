...
Scans GitHub Copilot agent definitions following the official priority hierarchy:

| Priority | Location | Scope |
|----------|----------|-------|
| High | `.github/agents/*.md` | Project-level specialists |
| Low | `~/.github/agents/*.md` | User-level reusable agents |
...
Agent definitions are standard GitHub Copilot agent files (`.github/agents/*.md`). No additional configuration is required — the extension discovers agents automatically using GitHub Copilot's built-in hierarchy.
...
cat > .github/agents/backend-dev.md << 'EOF'
---
...
| Issue | Solution |
|-------|----------|
| "No agent definition files found" | Create agent files in `.github/agents/` or `~/.github/agents/`, or use [agency-agents](https://github.com/msitarzewski/agency-agents) |
